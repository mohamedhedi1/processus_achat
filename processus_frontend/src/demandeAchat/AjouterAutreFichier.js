...
function AjouterAutreFichier(props) {
...
const allowedFiles = ['application/pdf'];
 ...
 if(id!== -1){
    return (
        ...
        class="btn btn-light btn-lg btn-block">Afficher le fichier</button>
         {previewbtn && pdfFile &&(
        ...
        <button type="submit" onClick={post} className="btn btn-success btn-lg btn-block">Ajouter le fichier</button>
        <button type="button" 
         onClick={() => {
          setId(-1)
        ...
        class="btn btn-danger btn-lg btn-block">Retirer le fichier</button>
        </form>
        </div>
      )
 }
...
export default AjouterAutreFichier