...
const AfficheFichiers = (fichier) => 
 ...
 <a href="#" className="btn theme-bg text-white">Valider</a>
 <a href="#" class="btn theme-bg2 text-white">Ajouter une Remarque</a>
 <a href="#" className="btn theme-bg text-white">Rejeter</a>
</div> */}
  ...
  <div className="card-body">
    ...
    <a href="#" className="btn btn-outline-success">Valider CC</a>
    <a href="#" class="btn theme-bg2 btn-outline-secondary">Ajouter une Remarque</a>
    <a href="#" className="btn btn-outline-danger">Rejeter CC</a>
  </div>
</div>
      </>
