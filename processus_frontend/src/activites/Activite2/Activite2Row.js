...
{ let demand=demande.demande.demande
  ...
  const[appdossier,setAppdossier]= useState({approuvationId:0,approuvation:"a",remarque:"",etape:2,demandeAchat:demandeId})
  console.log("oui")
