        ...
        <div className="navbar-wrapper">
            ...
            <div className="navbar-content scroll-div">
             ...
             <li  
              ...
              <li className="nav-item  pcoded-menu-caption">
                  <label >Structure de plantification <br/>  et de cordination  </label>
                  <ul className="nav pcoded-inner-navbar">
                  <li  
               ...
               <i className=	"feather icon-arrow-right"></i>
                   ...
                   <Link to='/activite1'  replace >Traitement de la demande achat</Link></span></a>
                  </li>
               ...
               <i className=	"feather icon-arrow-right"></i>
                   ...
                   <Link to='/activite7'  replace >Affectaion de dossier d'achat a une structure d 'achat</Link></span></a>
                  </li>
