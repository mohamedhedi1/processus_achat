             ...
             <li  
              ...
              <li className="nav-item  pcoded-menu-caption">
               ...
               <i className=	"feather icon-arrow-right"></i>
                   ...
                   <Link to='/activite7'  replace >Plantification les date de lancement de l'AO et 
                   de La séance d'ouvertur de plis
</Link></span></a>
                  </li>
                  <li  
                data-username="dashboard Default Ecommerce CRM Analytics Crypto Project"  className=  'nav-item  ' >
               ...
               <i className=	"feather icon-arrow-right"></i>
                   ...
                   <Link to='/activite7'  replace > statistique
                  ...
                  <li className="nav-item  pcoded-menu-caption">
                  <label >Commission ad hoc  <br/> d'approbation des CPT</label>
                  <ul className="nav pcoded-inner-navbar">
               ...
               <Link to='/activite3'  replace >Préparation de projet de CCAP</Link></span></a>
                  </li>
                  <li  
                data-username="dashboard Default Ecommerce CRM Analytics Crypto Project"  className=  'nav-item  ' >
               <a   className="nav-link "><span className="pcoded-micon">
